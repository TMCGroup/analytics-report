...
SOCIAL_AUTH_GOOGLE_OAUTH2_KEY = '1052377232890-vsgabd625ju0mgpi4md2i7haf2q6a6tp.apps.googleusercontent.com'
SOCIAL_AUTH_GOOGLE_OAUTH2_SECRET = 'tlZtpSRoXd1_XROadKZP40Gw'

LOGIN_REDIRECT_URL = '/admin/'

VOICE_DB_HOST = config('VOICE_DB_HOST')
VOICE_DB_NAME = config('VOICE_DB_NAME')
VOICE_DB_USERNAME = config('VOICE_DB_USERNAME')
VOICE_DB_PASSWORD = config('VOICE_DB_PASSWORD')
