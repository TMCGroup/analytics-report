# -*- coding: utf-8 -*-
# Generated by Django 1.11.1 on 2017-06-29 13:41
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('contact', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='reports.Contact')),
                ('flow', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='reports.Flow')),
            ],
        ),
        migrations.CreateModel(
            name='Step',
        ...
        migrations.AddField(
            model_name='email',
            name='project',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='reports.Group'),
        ),
    ]
